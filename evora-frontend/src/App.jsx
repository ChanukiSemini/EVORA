 ...
 * This is what scopes the auth flow's theme (colors, fonts,
 * .card/.btn-primary/.field styling) so it never leaks out and
 * affects the original LandingPage or BookCharger screens - see
 * the "Auth Flow Styles" section in src/index.css for the full
 * explanation.
 */
