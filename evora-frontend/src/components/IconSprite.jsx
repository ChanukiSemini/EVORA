/**
 * The <symbol> sprite that used to sit hardcoded at the top of
 * index.html (94 lines, parsed on every load before anything else).
 * It now renders once, as part of the React tree, right alongside the
 * components that actually use it.
 */
export default function IconSprite() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
            ...
            <symbol id="icon-bolt" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>
            </symbol>

            <symbol id="icon-dashboard" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <symbol id="icon-star-act" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <symbol id="icon-car" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="1" y="3" width="22" height="13" rx="2"></rect>
                <path d="M4 16v4h2v-4M18 16v4h2v-4M2 9h20"></path>
            </symbol>
