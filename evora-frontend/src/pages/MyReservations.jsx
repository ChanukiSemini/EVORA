                ...
                <div className="res-card-actions">
                    ...
                    {currentStatus === 'completed' && (
                        <div className="res-completed-actions-wrap">
                            <button
                                className="res-btn-primary-green"
                                onClick={() => navigate('/rate-session', { state: { bookingId: b?._id || b?.id, booking: b } })}
                            >
                            ...
                            <div className="res-modal-body">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: 20 }}>
                                    <button
                                        ...
                                        onClick={() => {
                                            setModalType(null);
                                            navigate('/rate-session', { state: { bookingId: selectedBooking?._id || selectedBooking?.id, booking: selectedBooking } });
                                        }}
