...
export default function MyVehicles() {
    ...
    const [deleteTarget, setDeleteTarget] = useState(null); // vehicle id pending deletion
    ...
    const confirmDelete = () => {
        ...
        // If the deleted vehicle was selected, pick the next available one
            ...
            <section className="card vehicle-hero-card animate-card">
                ...
                <div className="vehicle-hero-card__content">
                    <div className="vehicle-hero-card__topline">
                        <p className="eyebrow">Connected EV Fleet</p>
                    </div>
